...
const TaskCard = ({task, index, handleTaskChanged}) => {
    ...
    try {
      ...
      toast.error("Lỗi khi xóa công việc. Vui lòng thử lại.");
    }
    };
    ...
    try{
      ...
      toast.error("Lỗi khi cập nhật công việc. Vui lòng thử lại.");
    };
  };
  ...
  handleTaskChanged();
      ...
      toast.error("Lỗi khi cập nhật trạng thái công việc. Vui lòng thử lại.");
    }
  };
